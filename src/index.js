...
app.get("/aleatorio/:userId",(req, res) => {
...
// (las que tienes buena puntuacion)
app.get("/aleatorio/:userId/:number",(req, res) => {
...
app.get("/porSimilitudes/pelicula/:filmId/:userId",(req, res) => {
...
// sobre una película puntuada. La eleccion de estas peliculas se hace frente a las similaritudes 
// de notacion del usuario con las notas de los otos usuarios.
app.get("​/porSimilitudes​/pelicula​/:filmId}/:userId/:number",(req, res) => {
...
app.get("/porSimilitudes/serie/:serieId/:userId",(req, res) => {
...
app.get("/porSimilitudes/serie/:serieId/:userId/:number",(req, res) => {
